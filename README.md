...
Приведен универсальный пример который поможет в разработке более крупных приложений , требующий качественный проект, построение и высокую отказоустояичивость и тд.
